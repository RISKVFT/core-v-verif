##### FILE MODIFIFED BY MARCELLO FOR OUR RISCV32
#####
#####
...
RISCVTOOLS=/software/pulp/riscv
# Flag: RISCVTYPE
...
PORT_CFLAGS = -Os -g -static -mabi=ilp32 -march=rv32imc -Wall -pedantic --specs=nosys.specs 
#LD_FLAGS = -nostartfiles --specs=nosys.specs -nostdlib -L $(BSP) -lcv-verif -Wl,--start-group -lc -lgcc -lc -lm -Wl,--end-group -L $(BSP) -lcv-verif -T $(BSP)/link.ld
FLAGS_STR = "$(PORT_CFLAGS) $(XCFLAGS) $(XLFLAGS) $(LFLAGS_END)"
CFLAGS = $(PORT_CFLAGS) -I$(PORT_DIR) -I. -DFLAGS_STR=\"$(FLAGS_STR)\"
#Flag: LFLAGS_END
#	Define any libraries needed for linking or other flags that should come at the end of the link line (e.g. linker scripts).
#	Note: On certain platforms, the default clock_gettime implementation is supported but requires linking of librt.
#LFLAGS_END += -nostartfiles --specs=nosys.specs -nostdlib -L $(BSP) -lcv-verif -Wl,--start-group -lc -lgcc -lc -lm -Wl,--end-group -L $(BSP) -lcv-verif -T $(BSP)/link.ld
LFLAGS_END += -nostartfiles -T $(BSP)/link.ld -L $(BSP) -lcv-verif -nostdlib -lc -lgcc -lm -lc
# Flag: PORT_SRCS
# Port specific source files can be added here
PORT_SRCS = $(PORT_DIR)/core_portme.c #$(BSP)/syscalls.c $(BSP)/crt0.S
# Flag: LOAD
